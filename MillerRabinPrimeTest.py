...
k = 104770506322726060791195800523521;  
  
  
if (isPrime(45355197542305654022162684208, k)): 
    print(str(45355197542305654022162684208) + "is prime", end=" "); 
else:
    print (str(45355197542305654022162684208) + "is not prime")
